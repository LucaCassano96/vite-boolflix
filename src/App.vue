...
<template>
  ...
  <AppSearch @mysearch="getMovie"/> <!-- collego ad App l'emit fatto dal figlio in AppSearch all'arrivo della search viene chiamato il metodo getMovie-->
  <main>
    <MovieList/>
  </main>
...
@use "src/styles/general.scss" as *; /* import general  */
@use "src/styles/partials/variables.scss" as*; /*import variables   */
